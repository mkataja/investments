...
| [`web`](web) | Vite + React + Tailwind; portfolio UI, **brokers** at `/brokers`, **settings** at `/settings`, **instruments list** at `/instruments`, **new instrument** at `/instruments/new`, **Degiro CSV + IBKR CSV + Seligson TSV import** at `/import`, dev data checks |
