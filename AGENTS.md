...
Portfolio distribution charts (**`web/src/pages/home/PortfolioCharts.tsx`**) use **Chart.js** via **`react-chartjs-2`**; import **`web/src/lib/chart/registerChartJs.ts`** once from **`web/src/main.tsx`** (controllers/scales/tooltip plugins). External HTML tooltips (**`web/src/lib/chart/externalTooltip.tsx`**) render **`DistributionChartTooltip`** and **`PortfolioPieTooltip`**; layout classes are **`chart-tooltip`** / **`chart-tooltip__*`** in **`web/src/index.css`**.
